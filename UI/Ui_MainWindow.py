...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QRect(10, 109, 120, 20))
        font = QFont()
        font.setPointSize(11)
        self.label.setFont(font)
        self.searchEdit = QLineEdit(self.centralwidget)
        self.searchEdit.setObjectName(u"searchEdit")
        self.searchEdit.setGeometry(QRect(9, 130, 311, 40))
        ...
        self.tableWidget.setGeometry(QRect(10, 280, 621, 271))
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 253, 120, 20))
        self.label_2.setFont(font)
        self.searchButton = QPushButton(self.centralwidget)
        self.searchButton.setObjectName(u"searchButton")
        self.searchButton.setGeometry(QRect(10, 182, 131, 35))
        ...
        self.stopScrapingButton.setGeometry(QRect(180, 182, 141, 34))
        ...
        self.listNameEdit = QLineEdit(self.centralwidget)
        self.listNameEdit.setObjectName(u"listNameEdit")
        self.listNameEdit.setGeometry(QRect(9, 55, 311, 40))
        self.listNameEdit.setMinimumSize(QSize(0, 40))
        self.listNameEdit.setMaximumSize(QSize(16777215, 16777215))
        self.listNameEdit.setSizeIncrement(QSize(0, 40))
        self.listNameLabel = QLabel(self.centralwidget)
        self.listNameLabel.setObjectName(u"listNameLabel")
        self.listNameLabel.setGeometry(QRect(10, 32, 120, 21))
